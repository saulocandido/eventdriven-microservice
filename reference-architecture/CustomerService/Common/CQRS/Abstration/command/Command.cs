using CustomerService.Common.DDD.Abstration.Entities;
using MediatR;


namespace CustomerService.Common.CQRS.Abstration.command
{

    public abstract record Command(Guid EntityId = default, string? EntityETag = null) : ICommand, ICommandBase, IRequest<CommandResult>, IBaseRequest;
    ...
    public abstract record Command<TEntity> : ICommand<TEntity>, ICommandBase<TEntity>, ICommandBase, IRequest<CommandResult<TEntity>>, IBaseRequest where TEntity : Entity
    {
        ...
        //   TEntity:
        //     Entity type.
        protected Command(TEntity? Entity = null, Guid EntityId = default, string? EntityETag = null)
        {
